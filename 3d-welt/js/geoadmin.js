...
// Übernommen aus «Zeitreise Luftbilder» (Maps2.0), unabhängig von der Kartenbibliothek.
 ...
 */
const TS_CACHE_KEY = '3dwelt.swissimage.timestamps';
...
// ---------------------------------------------------------------------------
// Kachel-URLs (WMTS in EPSG:3857, Platzhalter {z}/{x}/{y})
...
/** Kachelindex (Slippy-Map, EPSG:3857) für einen Punkt und eine Stufe. */
export function tileIndexFor(lon, lat, z) {
  const n = 2 ** z;
...
/** Sinnvolle Kameradistanz (m) je nach Art des Treffers. */
export function rangeForOrigin(origin) {
  switch (origin) {
    case 'address': return 450;
    case 'parcel': return 450;
    case 'haltestellen': return 700;
    case 'gazetteer': return 1500;
    case 'zipcode': return 4500;
    case 'sn': return 4500;
    case 'gg25': return 7000;
    case 'district': return 25000;
    case 'kantone': return 70000;
    default: return 2000;
  }
}
